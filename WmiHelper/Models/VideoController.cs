namespace WmiHelper.Models
{
    ...
    public class VideoController
    {
        ...
        public string ColorTableEntries
        {
            get;
            set;
        }
        ...
        public string ICMIntent
        {
            get;
            set;
        }

        public string ICMMethod
        {
            get;
            set;
        }
        ...
        public string NumberOfVideoPages
        {
            get;
            set;
        }
        ...
        public string ReservedSystemPaletteEntries
        {
            get;
            set;
        }
        ...
        public string SystemPaletteEntries
        {
            get;
            set;
        }
